...
! lattice parameters
    ...
    integer,                parameter           :: Nbond = 3  ! triangular nearest-neighbor forward bonds
    integer,                parameter           :: Naux  = 2
    integer,                parameter           :: Nsec  = 4  ! b, c, b^dagger, c^dagger
    integer,                public              :: Nlx, Nly, NlxTherm, NlyTherm
    integer,                public              :: Lq, LqTherm
    integer,                public              :: Nsite, NsiteTherm ! space site number; L * L * Norb
    integer,                public              :: Ndim ! dimension of matix; number of bosonic creation or annihilation operators; Nsite * Nsec
...
!   MPI process: parallelization
    ...
    subroutine write_info()
        if (IRANK == 0) then
            ...
            write(50,*) '========================='
            write(50,*) 'DQMC for pairing Bose Hubbard on triangular lattice'
