...
[在线文档](https://www.yykspace.com/BAFQMC/zh/) · [开始使用](docs/getting-started.md) · [算法与约定](docs/algorithm.md) · [复现结果](benchmarks/paper/README.md) · [Agent 指南](AGENTS.md)
...
- [物理观测量与输出](docs/observables.md)：算符定义、归一化与文件对应。
- [扩展到其他模型](docs/model-development.md)：从哈密顿量到经过验证的实现。
